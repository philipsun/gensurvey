...
def main():
    TestDemo()
   # RenameSystem()
def MakePaperPara(project_name,test_case_name,idname,model_test,rouge_args = None):
    # In this
  ...
  #  test_case_name= main_dir+'/' + test_case_name
    ...
    return rank_para
def TestDemo(model_test =[],cmd = []):
    project_name = 'duc2006mult'
    test_case = 'mult'
    idname ={'head1':'01',
             'head2':'02',
             'onefromsrc':'03',
             ...
             'dtfipfone': '17',
             'BM25Okapione': '18',
             'wordclosetopiconev1':'20',
             'even':'21',
             'worddirectedclose':'22'
             }
    model_idname = idname#sxpRougeConfig.idname
    #model_test =['top5','top4','random','manual100']
 #   model_test = ['head1','head2','onefromsrc', 'bymodel0','simgraph','diffgraph','diffsimgraph']
    if len(model_test)==0:
        model_test = [ 'bymodel0', 'simgraph', 'diffsimgraph', 'simdiffskip','wordclosetopicone','wordclosesim','duc2006s15']
  ...
  #  rouge_args = None
    rank_para = MakePaperPara(project_name, test_case, model_idname, model_test,rouge_args)
   ...
   # cmd = ['rank','score']
    ...
    if 'makemodel' in cmd:
        ...
        doc_model_sent_file_list = sxpDUC2006main.LoadDocModelSentence()#[[['hellow'],['good']],[['doc2','sent1'], ['doc2', 'sent2']]]
...
def RankDocDemo(eachtest,docid,lens):
    ...
    #         tops.append(eachsent)
    # if eachtest == 'head1':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'head2':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'onefromsrc':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'bymodel0':
    #     tops = sxpDUC2006main.LoadSys(eachtest,docid)
    # elif eachtest == 'simgraph':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'diffgraph':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'diffsimgraph':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'simdiffskip':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # elif eachtest == 'wordclosetopic':
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    # else:
    #     tops = sxpDUC2006main.LoadSys(eachtest, docid)
    #
